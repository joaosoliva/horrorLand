...
public class MazeGenerator : MonoBehaviour
{
	...
	void CreateBlueprintStageDoors()
	{
		...
		for (int i = 0; i < activeBlueprint.edges.Count; i++)
		{
			...
			Vector2Int delta = edge.b - edge.a;
			...
			string stageTransition = edge.doorId;

			Debug.Log(
				"Tutorial Door:\n" +
				$"- id: {edge.doorId}\n" +
				$"- stage transition: {stageTransition}\n" +
				$"- cell A: ({edge.a.x},{edge.a.y})\n" +
				$"- cell B: ({edge.b.x},{edge.b.y})\n" +
			...
			if (doorTrigger == null)
			{
				Debug.LogError($"[MazeGenerator] Tutorial door missing DoorTrigger: {edge.doorId}");
			}
		}
	}
