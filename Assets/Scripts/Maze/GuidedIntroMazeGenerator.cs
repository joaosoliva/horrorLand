...
[System.Obsolete("Legacy guided intro geometry methods are retained only for compatibility. Tutorial geometry must be generated by MazeGenerator.")]
public class GuidedIntroMazeGenerator : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log("[GuidedIntroMazeGenerator] Legacy component active in data-provider mode. Tutorial geometry is generated by MazeGenerator.");
        GenerateLayout();
    }
    ...
    [System.Obsolete("Legacy guided intro geometry generation path is disabled. Tutorial geometry must be generated by MazeGenerator only.")]
    private void LogLegacyGeometryGenerationError()
    {
        Debug.LogError("ERROR: Legacy guided intro geometry generation is still active. Tutorial geometry must be generated by MazeGenerator only.");
    }
    ...
    {
        LogLegacyGeometryGenerationError();
        return new TutorialLayoutContext();
#if false
        TutorialLayoutContext context = new TutorialLayoutContext();
